...
public class Motors : MonoBehaviour
{
    ...
    public void MotorsState()
    {
        ...
        LBVoltage = LBActualThrottle * (GetComponent<Battery>().voltage / 4095f);
        LTVoltage = LTActualThrottle * (GetComponent<Battery>().voltage / 4095f);
        RBVoltage = RBActualThrottle * (GetComponent<Battery>().voltage / 4095f);
        RTVoltage = RTActualThrottle * (GetComponent<Battery>().voltage / 4095f);
        ...
        GetComponent<EnvironmentalMeasurementsAndEffects>().GenerateThrustOnMotors();
        ...
        GetComponent<Battery>().BatteryState();
